...
// setInterval(() => {
//   data.value.push({
//     amount: data.value[data.value.length - 1].amount + 10,
//     close: data.value[data.value.length - 1].high + 10,
//     high: data.value[data.value.length - 1].high + 10,
//     low: data.value[data.value.length - 1].low + 10,
//     next_page_token: null,
//     open: data.value[data.value.length - 1].open + 10,
//     symbol: "SPY",
//     time: data.value[data.value.length - 1].time + 100,
//     volume: data.value[data.value.length - 1].volume + 10,
//   });
//   let list2 = [...data.value];

//   data.value = list2;
// }, 1000);

function buy() {
  let lastCandleData = data.value[data.value.length - 1];
  // console.log(lastCandleData);

  // lastCandleData.open += 200;
  // lastCandleData.time = lastCandleData = time;

  data.value.push(lastCandleData);
